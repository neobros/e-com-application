...
<main class="main">
            ...
            <div class="container">
                <div class="page-header page-header-big text-center"
                    style="background-image: url('/customer/assets/images/about-header-bg.jpg')">
                        ...
                        <div class="row">
                            <div class="col-lg-5 mb-3 mb-lg-0">
                                ...
                                <p class="lead text-primary mb-3">Pellentesque odio nisi, euismod pharetra a ultricies
                                    <br>in diam. Sed arcu. Cras consequat</p><!-- End .lead text-primary -->
                            ...
                            <div class="col-lg-6 offset-lg-1">
                                <div class="about-images">
                                    <img src="/customer/assets/images/about/img-1.jpg" alt="" class="about-img-front">
                                    <img src="/customer/assets/images/about/img-2.jpg" alt="" class="about-img-back">
                ...
                <div class="container">
                        ...
                        <div class="col-lg-7">
                            <div class="brands-display">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="/customer/assets/images/brands/8.png" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="/customer/assets/images/brands/9.png" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->
                                </div><!-- End .row -->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="member member-anim text-center">
                                <figure class="member-media">
                                    <img src="/customer/assets/images/team/member-1.jpg" alt="member photo">

                                    <figcaption class="member-overlay">
                                        <div class="member-overlay-content">
                                            <h3 class="member-title">Samanta Grey<span>Founder & CEO</span></h3>
                                            <!-- End .member-title -->
                                            <p>Sed pretium, ligula sollicitudin viverra, tortor libero sodales leo, eget
                                                blandit nunc.</p>
                        ...
                        <div class="col-md-4">
                            <div class="member member-anim text-center">
                                <figure class="member-media">
                                    <img src="/customer/assets/images/team/member-2.jpg" alt="member photo">

                                    <figcaption class="member-overlay">
                                        <div class="member-overlay-content">
                                            <h3 class="member-title">Bruce Sutton<span>Sales & Marketing Manager</span>
                                            </h3><!-- End .member-title -->
                                            <p>Sed pretium, ligula sollicitudin viverra, tortor libero sodales leo, eget
                                                blandit nunc.</p>
                                            <div class="social-icons social-icons-simple">
                        ...
                        <div class="col-md-4">
                            <div class="member member-anim text-center">
                                <figure class="member-media">
                                    <img src="/customer/assets/images/team/member-3.jpg" alt="member photo">
                    ...
                    <div class="container">
                        ...
                        <div class="owl-carousel owl-simple owl-testimonials-photo" data-toggle="owl" data-owl-options='{
                            ...
                            <blockquote class="testimonial text-center">
                                <img src="/customer/assets/images/testimonials/user-1.jpg" alt="user">
                            ...
                            <blockquote class="testimonial text-center">
                                <img src="/customer/assets/images/testimonials/user-2.jpg" alt="user">
