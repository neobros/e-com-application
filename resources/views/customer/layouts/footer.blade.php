<footer class="footer">
            <div class="cta bg-image bg-dark pt-4 pb-5 mb-0"
                style="background-image: url(/customer/assets/images/demos/demo-4/bg-5.jpg);">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-3">
                            <div class="widget widget-about">
                                <img src="/customer/assets/images/demos/demo-4/logo-footer.png" class="footer-logo"
            ...
            <div class="footer-bottom">
                <div class="container">
                    ...
                    <figure class="footer-payments">
                        <img src="/customer/assets/images/payments.png" alt="Payment methods" width="272" height="20">
